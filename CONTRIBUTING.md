...
Do not rewrite [docs/research/architecture.md](docs/research/architecture.md) as a side effect of a small engine change; update it when the current system design actually moved. Do not commit `docs/research/design-history.md` — that file is gitignored local research, not the shipped contract.
