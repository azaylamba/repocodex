...
| Canonical design (further reading) | [docs/research/architecture.md](docs/research/architecture.md) |
...
This checkout builds that engine. Audience: coding agents first. Engine pytest pins CLI and attester behavior; it is not how application scenarios are verified. Do not rewrite `docs/research/architecture.md` as a side effect of a small change.
